...
The aim of the workshop is to equip participants with the skills to plot using `ggplot2`, which implements the concept of the "grammar of graphics". This workshop is suitable for those that are already familiar with R but have little to no experience using `ggplot2` to draw plots. 
